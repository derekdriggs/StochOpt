function [xk1, its, ek, fk, sk, gk] = func_katyusha(para, GradF, iGradF, ObjF, ProxJ)
%
...
% "x_old" keeps track of iterates to update x_tilde
x_old   = x0;
...
while(its<maxits)
    ...
    for p=1:P
        ...
        % Update z
        w = z - gamma* ( Gj_k1 - Gj_k2 + mu );
        z = ProxJ(w, gamma*lambda);
